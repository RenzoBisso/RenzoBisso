![mountain](https://images.pexels.com/photos/686047/pexels-photo-686047.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)
# Hola 👋 ! Mi nombre es Renzo Martin Bisso y soy estudiante universitario de la carrera Licenciatura en Sistemas de Información
...
Además de mi formación académica, he buscado ampliar mis conocimientos de manera autodidacta y a través de cursos adicionales. Mi objetivo es seguir creciendo en el ambiente IT. Estoy abierto a oportunidades de aprendizaje y colaboración en proyectos. Actualmente estoy estudiando de manera autodidacta el desarrollo backend siguiendo la ruta de ![roadmap.sh](https://roadmap.sh/backend). 
